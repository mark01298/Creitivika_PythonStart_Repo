...
difficultylevel = input("Какой выбираете уровень сложности? Есть легкий, средний, сложный и невозможный")
if difficultylevel == "средний": medium()
...
if difficultylevel == "сложный":
    ...
    file2_2.close()
    print("Это ваша "+str(win2)+" победа")
if difficultylevel == "невозможный":
	a1 = random.randint(1,1000)
	popitka = 0
	chislo = 0
	ochki = 0
	...
	file2_2.close()
	print("Это ваша "+str(win2)+" победа")
shoditliinthestore = input("Хотите ли вы сходить в магазин?")
if shoditliinthestore == "да":
	buy1 = input("Хотите купить дом? Он стоит 500000 очков")
	if buy1 == "да":
		ochki2 = ochki2 - 500000
	else:
		pass
	buy2 = input("Хотите купить машину? Она стоит 1000000 очков")
	if buy2 == "да":
		ochki2 = ochki2 - 1000000
	else:
		pass
	buy3 = input("Хотите купить много котиков и собачек? Они стоят 1 улыбки")